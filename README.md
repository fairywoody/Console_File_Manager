# Console File Manager - Command Line File Manager

Console File Manager is a command-line utility for managing files and directories with various features such as copying, moving, deleting, counting files, adding date prefixes, and analyzing directory size.

This project uses only Python standard libraries:
os, sys, shutil, argparse, datetime, tempfile, unittest, io, subprocess
...
git clone https://github.com/fairywoody/Console_File_Manager
